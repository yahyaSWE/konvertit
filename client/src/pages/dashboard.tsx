    ...
    <AppLayout>
      <div className="p-6">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-8">
          <div>
            <h1 className="text-2xl font-poppins font-bold text-textColor">Your Learning Dashboard</h1>
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
          ...
          <TabsContent value="quickstart" className="mt-0">
            ...
            {/* Recommended Courses - simplified version */}
            <div>
              <div className="flex items-center justify-between mb-6">
                <h2 className="text-xl font-poppins font-semibold text-textColor">Recommended for You</h2>
                <a href="/courses" className="text-primary text-sm font-medium hover:underline">View all</a>
              </div>
          ...
          <TabsContent value="detailed" className="mt-0">
            ...
            <div className="mb-10">
              <div className="flex items-center justify-between mb-6">
                <h2 className="text-xl font-poppins font-semibold text-textColor">Continue Learning</h2>
                <a href="/courses" className="text-primary text-sm font-medium hover:underline">View all courses</a>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {!enrollmentsLoading && inProgressCourses?.length === 0 && (
                  <div className="col-span-full text-center py-10 bg-white rounded-xl shadow-sm border border-gray-100">
                    ...
                    <p className="text-gray-600 mb-2">You don't have any courses in progress</p>
                    <a href="/courses" className="text-primary font-medium hover:underline">Browse courses to get started</a>
                  </div>
                )}
